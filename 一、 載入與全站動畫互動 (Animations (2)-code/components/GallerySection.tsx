...
const galleryItems = [
  {
    ...
    domainEn: 'Game',
    year: '2026',
    desc: '多人派對遊戲，搶奪資源、建立同盟，在混亂中尋找勝機。',
  ...
  },
  {
    ...
    title: '感知邊界',
    domain: '互動',
    domainEn: 'Interactive',
    year: '2026',
    desc: '以身體為介面的沉浸式裝置，探索感知的極限與可能。',
  ...
  },
  {
    ...
    domainEn: 'Film',
    year: '2026',
    desc: '一部關於溝通與誤解的短片，在數位噪音中尋找真實的連結。',
  ...
  },
  {
    ...
    domainEn: 'Marketing',
    year: '2026',
    desc: '整合品牌識別系統，讓每一個觸點都成為記憶的神經節點。',
